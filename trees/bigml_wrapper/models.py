...
models = {
    ...
    'credit':    "5cd95e11de2d4d73f3003d2d",    # german credit
    'gss':       "5124321c035d071fdc000fda",    # GSS happiness survey  => GOOD!
    'email':     "52fa8aa60c0b5e6d4a0030c1",    # email importance      => good
    'spaem':      "56a09a9d200d5a337100d4b9",    # spam email            => good
    'tax':       "5cda5d47db8b1d087700a99c",    # tax patterns          => GOOD!
...
black_box_models = {
    ...
    'steak': "5cda3bc5de2d4d73f30041b0"
}
